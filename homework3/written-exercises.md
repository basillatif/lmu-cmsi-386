...
The third declaration creates a pointer c of type doubke that points to a location index n in the array and calls the function that is existent at the index.
